...
const createRide = async (req) => {
    const { name, description, thrill_level, height_restrictions, current_wait_time } = req;
    if (name == null || description == null || thrill_level == null || height_restrictions == null || current_wait_time == null) {
